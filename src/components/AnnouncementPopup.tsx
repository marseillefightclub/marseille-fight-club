...
export default function AnnouncementPopup() {
  ...
  useEffect(() => {
    // Check if the popup has been closed before in this session
    const hasClosed = sessionStorage.getItem("mfc-rentree-2026-closed");
  ...
  const handleClose = () => {
    setIsOpen(false);
    // Store in sessionStorage to prevent showing again during this visit
    sessionStorage.setItem("mfc-rentree-2026-closed", "true");
  };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center text-center p-8 sm:p-10">
              ...
              <h2 id="popup-title" className="text-xl sm:text-2xl font-light text-gray-300 mb-3">
                La nouvelle saison commence le
              </h2>
